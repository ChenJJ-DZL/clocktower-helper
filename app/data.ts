...
export const scripts: Script[] = [
  {
    ...
    difficulty: "初学者",
    description:
      "当?男爵 (Baron)?在场时，系统会自动将 2 名镇民替换为 2 名外来者。",
    roleIds: [
      "washerwoman",
      "librarian",
      "investigator",
      ...
      "imp",
      "traveler_official",
      "experimental_sing_boy",
      "experimental_king",
      "experimental_general",
      "experimental_balloonist",
      "experimental_bounty_hunter",
      "experimental_nightwatchman",
      "experimental_pixie",
      "experimental_heretic",
      "experimental_snitch",
      "experimental_goblin",
      "experimental_puppet",
      "experimental_boomdandy",
      "experimental_leviathan",
      "experimental_mafia",
    ],
  },
  {
