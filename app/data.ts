...
export const scripts: Script[] = [
  ...
  { id: "bad_moon_rising", name: "黯月初升", difficulty: "中等", description: "" },
...
export const roles: Role[] = [
  ...
  // ========== 镇民 (Townsfolk) - 夜半狂欢 ==========
  {
    ...
    fullDescription: "在你的首个夜晚，你会得知三名玩家：其中有且只有一名玩家是邪恶的。",
    script: "夜半狂欢"
  },
  {
    id: "balloonist",
  ...
  },
  {
    ...
    fullDescription: "每局游戏限一次，在夜晚时，你可以选择让恶魔变成你选择的恶魔角色，或让所有爪牙变成你选择的爪牙角色。",
    script: "夜半狂欢"
  },
  {
    id: "fisherman",
    name: "渔夫",
    type: "townsfolk",
    ability: "每局游戏限一次，在白天时，你可以让说书人给你一些帮助你的阵营获胜的建议。",
    fullDescription: "每局游戏限一次，在白天时，你可以让说书人给你一些帮助你的阵营获胜的建议。",
    script: "夜半狂欢"
  },
  {
    id: "farmer",
  ...
  },
  {
    ...
    fullDescription: "你拥有上个死于处决的玩家的能力。如果该玩家属于邪恶阵营，你中毒直到下个善良玩家死于处决。",
    script: "夜半狂欢"
  },
  {
    id: "poppy_grower",
  ...
  },
  {
    ...
    fullDescription: "说书人可以打破游戏规则。如果说书人被处决，善良阵营获胜，即使你已死亡。[无邪恶角色在场]",
    script: "夜半狂欢"
  },
  // ========== 爪牙 (Minion) - 4个 ==========
  {
