...
export interface DayActionMeta {
  ...
  publicActivation?: boolean; // 是否需要公开声明使用能力（所有玩家可见）
}
...
export const scripts: Script[] = [
  {
    ...
    name: "暗流涌动",
    difficulty: "初学者",
    description: "在《暗流涌动》中，每种要素都会略有涉及。一些角色会被动地获取信息，一些角色则需要通过行动来得知谁是谁，而一些角色则单纯只是想诱使恶魔攻击他们。善良与邪恶双方都可以适时做出牺牲以占据上风。 《暗流涌动》是一场对恶魔长驱直入的狩猎，然而邪恶方也有一连串混淆信息的卑鄙把戏。所以如果善良玩家想要求得生存，最好先质疑自己原本的认知。 难度：初学者。推荐给那些初学《染》和这类社交推理游戏的玩家及说书人。 当你",
    roleIds: [
      "washerwoman",
      "librarian",
      "investigator",
  ...
  {
    id: "whispering_secrets",
    name: "窃窃私语",
    difficulty: "中等",
    description: "窃窃私语是汀西维尔模式的中型剧本，适合7-10人游戏。这个剧本以信息传播、谣言和秘密为核心主题，大量角色的能力都与信息交换、秘密获取、谣言验证相关。善良阵营能够通过各种方式获得信息，但这些信息可能经过了多次传递，存在被篡改的可能。邪恶阵营则可以通过散布虚假信息来误导善良阵营。这个剧本非常考验玩家的沟通能力和信息辨别能力，需要玩家通过多个信息源的交叉验证来判断真相。适合有一定游戏经验的玩家体验。",
    roleIds: [
      "chambermaid",
      "gossip",
      "messenger",
  ...
  {
    id: "tomb_of_the_unknown",
    name: "无名之墓",
    difficulty: "中等偏难",
    description: "无名之墓是一个围绕死亡和亡灵主题设计的官方剧本，包含大量与死亡信息、身份伪装、死后能力相关的角色。这个剧本的核心乐趣在于信息的不确定性，许多角色的能力都会干扰或伪造死亡信息，使得善良阵营很难通过常规的死亡信息来判断角色身份。恶魔和爪牙拥有强大的伪装和误导能力，而善良阵营则需要通过缜密的逻辑推理和信息整合来辨别真相。适合有一定游戏经验、熟悉基础规则的玩家体验。",
    roleIds: [
      "gravedigger",
      "undertaker",
      "gambler",
  ...
  },
  {
    ...
    name: "无上愉悦",
    difficulty: "简单",
    description: "无上愉悦是汀西维尔模式的小型剧本，专为5-8人的小规模游戏设计。这个剧本的规则简单，角色能力直观，没有过于复杂的机制和误导性信息，非常适合新手玩家入门。善良阵营能够获得较为明确的信息，而邪恶阵营的能力也相对直接，游戏节奏快，通常在2-3小时内就能完成。非常适合朋友聚会、新人入门或者想要轻松体验游戏乐趣的场景。",
    roleIds: [
      "washerwoman",
      "investigator",
      "chef",
  ...
  },
  {
    ...
    name: "凶宅魅影",
    difficulty: "困难",
    description: "凶宅魅影是官方剧本中难度最高的剧本之一，以幻觉、记忆篡改、信息迷惑为核心主题。几乎所有角色的能力都带有欺骗性或误导性，善良阵营获得的大部分信息都可能是错误的或被篡改的。恶魔拥有极为强大的干扰能力，能够伪造各种信息，甚至改变游戏规则。这个剧本极度考验玩家的逻辑推理能力和心理素质，需要玩家在大量虚假信息中找到唯一的真相。仅推荐经验非常丰富的玩家群体体验。",
    roleIds: [
      "traveler_balloonist",
      "prophet",
      "mathematician",
  ...
  },
  {
    ...
    name: "游园惊梦",
    difficulty: "中等",
    description: "《游园惊梦》将是对纯粹的逻辑思维的一场巨大挑战。每个善良角色，甚至是外来者，都会获得一些信息。恶魔不会在夜晚攻击，但是会在固定的天数后自动获胜。悠闲的节奏给了玩家足够的时间来拼凑线索的拼图，但诡异的逻辑和违反直觉的信息意味着，善良玩家必须合作起来思考，否则等待他们的只有灭亡。适合头脑冷静的逻辑型玩家。",
    roleIds: [
      "clockmaker",
      "dreamer",
      "mathematician",
...
export const roles: Role[] = [
  // ========== 镇民 (Townsfolk) - 13个 ==========
  {
    ...
    fullDescription:
      "在你的首个夜晚,你会得知两名玩家和一个角色:这两名玩家之一是该角色。",
    script: "暗流涌动", // 暗流涌动角色
  },
  {
    id: "librarian",
  ...
  },
  {
    ...
    fullDescription:
      "每局游戏一次,你可以在白天公开选择一名玩家:如果他是恶魔,他死亡。",
    script: "暗流涌动", // 暗流涌动角色
  },
  {
    id: "soldier",
  ...
  },
  {
    ...
    fullDescription:
      "如果只有三名玩家存活且白天没有人能被处决,你会被选为镇长. 如果你在夜晚即将死亡,可能会有一名其他玩家代替你死亡。",
    script: "暗流涌动", // 暗流涌动角色
  },
  {
    id: "grandmother",
  ...
  },
  {
    ...
    ability:
      "【扩展镇民】每个夜晚*，你要选择一名玩家：你会得知一个其所没有的善良角色。每局游戏限一次，你可以选择不使用能力。",
    fullDescription:
      "每个夜晚*,你要选择一名玩家:你会得知一个其所没有的善良角色。每局游戏限一次,你可以选择不使用能力。",
    script: "暗流涌动",
  ...
  },
  {
    ...
    ability:
      "【扩展镇民】你的能力只有在没有吟游诗人在场时才能生效。每个夜晚*，你的一名存活的邻座玩家不会死亡。",
    fullDescription:
  ...
  },
  {
    ...
    ability:
      "【扩展镇民】每个夜晚*，你要选择一名玩家：你会被唤醒并得知他的角色，如果他是酒鬼、投毒者或恶魔，你也会醉酒。",
    fullDescription:
      "每个夜晚*,你要选择一名玩家:你会被唤醒并得知他的角色,如果他是酒鬼、投毒者或恶魔,你也会醉酒。",
    script: "暗流涌动",
  ...
  },
  {
    ...
    ability:
      "【扩展镇民】每个夜晚*，你要选择除你以外的一名玩家：当晚恶魔的负面能力对他无效。",
    fullDescription:
  ...
  // ========== 外来者 (Outsider) - 4个 ==========
  {
    ...
    fullDescription:
      "每个夜晚,你要选择除你以外的一名玩家:白天,只有他投票时你才能投票。",
    script: "暗流涌动", // 暗流涌动角色
  },
  {
    id: "drunk",
  ...
  },
  {
    ...
    fullDescription:
      "每个夜晚, 你能查看剧本. 你可能会被当作其他阵营、镇民角色或外来者角色, 即使你已死亡。",
    script: "暗流涌动", // 暗流涌动角色
  },
  {
    id: "scarlet_woman",
    ...
    fullDescription:
      "如果大于等于五名玩家存活时(说书人不计算在内)恶魔死亡, 你变成新的恶魔。",
    script: "暗流涌动", // 暗流涌动角色
  },
  {
    id: "baron",
  ...
  // ========== 恶魔 (Demon) - 1个 ==========
  {
    ...
    fullDescription:
      "每个夜晚, 你要选择一名玩家:他死亡。如果你以这种方式自杀死一名爪牙会变成小恶魔。",
    script: "暗流涌动", // 暗流涌动角色
  },
  // ======================================================================
  //  角色数据 - 黯月初升 (Bad Moon Rising)
  // ======================================================================
  ...
  },
  {
    ...
    type: "townsfolk",
    ability:
      "每晚选择一名存活的玩家：你或他之一会醉酒直到下个黄昏。你不会死亡。",
    fullDescription:
      "每个夜晚,你要选择一名存活的玩家:你或他之一会醉酒直到下个黄昏。你不会死亡。",
    script: "黯月初升",
  },
  {
    ...
    type: "townsfolk",
    ability:
      "每晚选择除你以外的两名存活的玩家：你会得知他们中有几人在当晚因其自身能力而被唤醒。",
    fullDescription:
      "每个夜晚,你要选择除你以外的两名存活的玩家:你会得知他们中有几人在当晚因其自身能力而被唤醒。",
    script: "黯月初升",
  },
  {
    ...
    type: "townsfolk",
    ability:
      "每晚选择一名玩家(与上个夜晚不同)：如果你选中了恶魔，他会得知你是驱魔人，但他当晚不会因其自身能力而被唤醒。",
    fullDescription:
  ...
  },
  {
    ...
    fullDescription:
      "每个夜晚*,你要选择一名玩家并猜测他的角色:如果你猜错了,你会死亡。",
    script: "黯月初升",
  },
  {
    id: "gossip",
    ...
    type: "townsfolk",
    ability:
      "每个白天，你可以公开发表一个声明。如果该声明正确，在当晚会有一名玩家死亡。（无夜晚行动）",
    fullDescription:
  ...
  },
  {
    ...
    type: "townsfolk",
    ability:
      "当一名爪牙死于处决时，除了你和旅行者以外的所有其他玩家醉酒直到明天黄昏。（无夜晚行动）",
    fullDescription:
  ...
  // ========== 爪牙 (Minion) - 4个 ==========
  {
    ...
    type: "minion",
    ability:
      "首夜得知有哪些外来者角色在场。如果有外来者在白天死亡，你会在当晚被唤醒并且你要选择一名玩家：他死亡。[-1或+1外来者]",
    fullDescription:
      "在你的首个夜晚,你会得知有哪些外来者角色在场。如果有外来者在白天死亡,你会在当晚被唤醒并且你要选择一名玩家:他死亡。[-1或+1外来者]",
    script: "黯月初升",
  },
  {
    id: "devils_advocate",
    ...
    type: "minion",
    ability:
      "每晚选择一名存活的玩家(与上个夜晚不同)：如果明天白天他被处决，他不会死亡。",
    fullDescription:
  ...
  },
  {
    ...
    type: "minion",
    ability:
      "如果恶魔死于处决而因此导致游戏结束时，再额外进行一个夜晚和一个白天。在那个白天如果有玩家被处决，他的阵营落败。",
    fullDescription:
      "如果恶魔死于处决而因此导致游戏结束时,再额外进行一个夜晚和一个白天。在那个白天如果有玩家被处决,他的阵营落败。",
    script: "黯月初升",
  },
  // ========== 恶魔 (Demon) - 4个 ==========
  {
    ...
    type: "demon",
    ability:
      "每晚如果今天白天没有人死亡，你会被唤醒并要选择一名玩家：他死亡。当你首次死亡后，你仍存活，但会被当作死亡。",
    fullDescription:
  ...
  },
  {
    ...
    type: "demon",
    ability:
      "每晚选择一名玩家：他中毒。上个因你的能力中毒的玩家会死亡并恢复健康。",
    fullDescription:
  ...
  },
  {
    ...
    type: "demon",
    ability:
      "每晚选择两名玩家：他们死亡。你的上个夜晚选择过的且当前死亡的玩家可能会被你反刍。",
    fullDescription:
      "每个夜晚*,你要选择两名玩家:他们死亡。你的上个夜晚选择过的且当前死亡的玩家可能会被你反刍。",
    script: "黯月初升",
  },
  {
    id: "po",
    ...
    type: "demon",
    ability:
      "每晚你可以选择一名玩家：他死亡。如果你上次选择时没有选择任何玩家，当晚你要选择三名玩家：他们死亡。",
    fullDescription:
      "每个夜晚*,你可以选择一名玩家:他死亡。如果你上次选择时没有选择任何玩家,当晚你要选择三名玩家:他们死亡。",
    script: "黯月初升",
  },
  // ========== 黯月初升 - 实验性角色（卡牌版扩展，不在前台露出） ==========
  {
    id: "missionary",
    name: "传教士",
    type: "townsfolk",
    ...
    script: "黯月初升",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E4%BC%A0%E6%95%99%E5%A3%AB",
  },
  {
    id: "alchemist",
    name: "炼金术士",
    ...
    script: "黯月初升",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E7%82%BC%E9%87%91%E6%9C%AF%E5%A3%AB",
  },
  {
    id: "magician",
    name: "魔术师",
    ...
    script: "黯月初升",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E9%AD%94%E6%9C%AF%E5%B8%88",
  },
  {
    id: "acrobat",
    name: "杂技演员",
    ...
    script: "黯月初升",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E6%9D%82%E6%8A%80%E6%BC%94%E5%91%98",
  },
  {
    id: "widow",
    name: "寡妇",
    ...
    script: "黯月初升",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E5%AF%A1%E5%A6%87",
  },
  {
    id: "organ_grinder",
    name: "街头风琴手",
    ...
    ability:
      "【实验性角色】所有玩家投票闭眼，票数秘密统计；每晚可选择自己是否醉酒到下个黄昏（醉酒则投票恢复公开）。",
    fullDescription: "",
    script: "实验性角色",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E8%A1%97%E5%A4%B4%E9%A3%8E%E7%90%B4%E6%89%8B",
  },
  {
    id: "boffin",
    name: "科学怪人",
    ...
    ability:
      "【实验性角色】恶魔拥有一个不在场善良角色的能力（即使恶魔醉酒/中毒）；你与恶魔都知道获得了什么能力。",
    fullDescription: "",
    script: "实验性角色",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E7%A7%91%E5%AD%A6%E6%80%AA%E4%BA%BA",
  },
  {
    id: "fearmonger",
    name: "恐惧之灵",
    ...
    ability:
      "【实验性角色】每晚选择一名玩家；若你提名他且他被处决，则该玩家阵营落败（首次/更换目标会广播）。",
    fullDescription: "",
    script: "实验性角色",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E6%81%90%E6%83%A7%E4%B9%8B%E7%81%B5",
  },
  {
    id: "wizard",
    name: "巫师",
    ...
    ability:
      "【实验性角色】每局限一次：向说书人许愿；愿望可能实现并伴随代价和线索。",
    fullDescription: "",
    script: "实验性角色",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E5%B7%AB%E5%B8%88",
  },
  {
    id: "xaan",
    name: "限",
    ...
    ability:
      "【实验性角色】在等同于初始外来者数量的夜晚，所有镇民中毒直到下个黄昏；且外来者数量可被调整。",
    fullDescription: "",
    script: "实验性角色",
  ...
  },
  {
    ...
    script: "黯月初升",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E7%97%A2%E8%9B%AD",
  },
  // ======================================================================
  ...
  },
  {
    ...
    type: "townsfolk",
    ability:
      "每晚选择一名玩家，得知一个善良角色和一个邪恶角色，该玩家是其中一个角色。",
    fullDescription:
  ...
  },
  {
    ...
    type: "townsfolk",
    ability:
      "每晚选择一名玩家，如果选中了恶魔，你和他交换角色和阵营，然后他中毒。",
    fullDescription:
  ...
  },
  {
    ...
    type: "townsfolk",
    ability:
      "在你的首个白天，你可以公开猜测任意玩家的角色最多五次，在当晚，你会得知猜测正确的角色数。",
    fullDescription:
      "在你的首个白天,你可以公开猜测任意玩家的角色最多五次,在当晚,你会得知猜测正确的角色数。",
    script: "梦陨春宵",
  },
  ...
  //  来源：json/blood_clocktower_所有镇民.json
  // ======================================================================
  {
    id: "half_ogre",
    name: "半兽人",
    ...
    script: "扩展",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E5%8D%8A%E5%85%BD%E4%BA%BA",
  },
  {
    id: "banshee",
    name: "报丧女妖",
    ...
    script: "扩展",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E6%8A%A5%E4%B8%A7%E5%A5%B3%E5%A6%96",
  },
  {
    id: "villager",
    name: "村夫",
    ...
    script: "扩展",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E6%9D%91%E5%A4%AB",
  },
  {
    id: "princess",
    name: "公主",
    ...
    script: "扩展",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E5%85%AC%E4%B8%BB",
  },
  {
    id: "priestess",
    name: "女祭司",
    ...
    script: "扩展",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E5%A5%B3%E7%A5%AD%E5%8F%B8",
  },
  {
    id: "knight",
    name: "骑士",
    ...
    script: "扩展",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E9%AA%91%E5%A3%AB",
  },
  {
    id: "steward",
    name: "事务官",
    ...
    script: "扩展",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E4%BA%8B%E5%8A%A1%E5%AE%98",
  },
  {
    id: "conjurer",
    name: "戏法师",
    ...
    script: "扩展",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E6%88%8F%E6%B3%95%E5%B8%88",
  },
  {
    id: "pilgrim",
    name: "修行者",
    ...
    script: "扩展",
    docRef:
      "https://clocktower-wiki.gstonegames.com/index.php?title=%E4%BF%AE%E8%A1%8C%E8%80%85",
  },
  // ========== 外来者 (Outsider) - 4个 ==========
  {
    id: "mutant",
  ...
  },
  {
    ...
    type: "minion",
    ability:
      "每晚选择一名玩家，如果他明天白天发起提名，他死亡。如果只有三名存活的玩家，你失去此能力。",
    fullDescription:
  ...
  },
  {
    ...
    type: "minion",
    ability:
      '每晚选择一名玩家和一个善良角色，他明天白天和夜晚需要"疯狂"地证明自己是这个角色，不然他可能被处决。',
    fullDescription:
  ...
  },
  {
    ...
    type: "minion",
    ability:
      "每晚选两人，首位需白天公开称次位为爪牙，否则你们之一会死（占位）。",
    fullDescription:
      "每晚选两人，首位需白天公开称次位为爪牙，否则你们之一会死（占位）。",
  ...
  // ========== 恶魔 (Demon) - 4个 ==========
  {
    ...
    type: "demon",
    ability:
      "每晚选择一名玩家：他死亡。被该能力杀死的外来者改为变成邪恶的方古且你代替他死亡，但每局游戏仅能成功转化一次。",
    fullDescription:
  ...
  },
  {
    ...
    type: "demon",
    ability:
      "每晚选择一名玩家：他死亡。镇民玩家的能力都会产生错误信息，如果白天没人被处决，邪恶阵营获胜。",
    fullDescription:
  ...
  },
  {
    ...
    fullDescription:
      "每个夜晚,你会得知一名不同角色类型的玩家,直到你得知了场上所有角色类型。[+1外来者]",
    script: "夜半狂欢",
  },
  {
    id: "amnesiac",
  ...
  },
  {
    ...
    type: "townsfolk",
    ability:
      "每局游戏一次，在夜晚时，你可以选择让恶魔变成你选择的一个恶魔角色，或让所有爪牙变成你选择的爪牙角色。",
    fullDescription:
      "每局游戏一次,在夜晚时*,你可以选择让恶魔变成你选择的一个恶魔角色,或让所有爪牙变成你选择的爪牙角色。",
    script: "夜半狂欢",
  },
  {
    ...
    type: "townsfolk",
    ability:
      "每局游戏一次，在白天时，你可以询问说书人一些建议来帮助你的团队获胜。",
    fullDescription:
      "每局游戏一次,在白天时,你可以询问说书人一些建议来帮助你的团队获胜。",
    script: "夜半狂欢",
  },
  {
    ...
    type: "townsfolk",
    ability:
      "每局游戏一次，在夜晚时，可以选择一名存活的玩家；如果选中了落难少女，她会变成一个不在场的镇民角色。",
    fullDescription:
      "每局游戏一次,在夜晚时*,你可以选择一名存活的玩家;如果选中了落难少女,她会变成一个不在场的镇民角色。[+落难少女]",
    script: "夜半狂欢",
  },
  {
    id: "farmer",
  ...
  },
  {
    ...
    type: "townsfolk",
    ability:
      "说书人可以打破游戏规则。如果说书人被处决，好人阵营获胜，即使你已死亡。",
    fullDescription:
      "说书人可以打破游戏规则。如果说书人被处决,好人阵营获胜,即使你已死亡。[场上没有邪恶角色]",
    script: "夜半狂欢",
  },
  {
    id: "cannibal",
    ...
    type: "townsfolk",
    ability:
      "你拥有最后被处决的玩家的能力。如果该玩家是邪恶的，你会中毒直到下一个善良玩家被处决。",
    fullDescription:
      "你拥有最后被处决的玩家的能力。如果该玩家是邪恶的,你会中毒直到下一个善良玩家被处决。",
    script: "夜半狂欢",
  },
  ...
  },
  {
    ...
    type: "minion",
    ability:
      "每个白天，在提名开始前，你可以公开选择一名玩家：他死亡。如果你被处决，提名你的玩家必须和你玩石头剪刀布；只有你输了才会死亡。",
    fullDescription:
      "每个白天,在提名开始前,你可以公开选择一名玩家:他死亡。如果你被处决,提名你的玩家必须和你玩石头剪刀布;只有你输了才会死亡。",
    script: "夜半狂欢",
  },
  {
    ...
    fullDescription:
      "在你的首个夜晚,你会得知一个关键词。第一个公开说出这个关键词的善良玩家会在当晚变成邪恶。",
    script: "夜半狂欢",
  },
  // ========== 恶魔 (Demon) - 2个 ==========
  {
  ...
  },
  {
    ...
    type: "demon",
    ability:
      "每晚选择三名玩家（所有玩家都会得知你选择了谁）：他们秘密决定自己的命运，如果他们全部存活，他们全部死亡。",
    fullDescription:
      "每个夜晚*,你要选择三名玩家(所有玩家都会得知你选择了谁):他们秘密决定自己的命运,如果他们全部存活,他们全部死亡。",
    script: "夜半狂欢",
  },
  // ========== 传奇角色 (Legendary) ==========
  {
  ...
  },
  {
    ...
    name: "圣洁之魂",
    type: "traveler",
    ability: "游戏过程中邪恶玩家的总数最多比初始设置多一名。",
    fullDescription: "游戏过程中邪恶玩家的总数最多比初始设置多一名。",
    script: "夜半狂欢",
  },
  {
    id: "legion",
    ...
    ability:
      "【实验性角色】多数玩家为军团，提名只有邪恶投票则记 0 票，夜晚可能有 1 人死亡。",
    fullDescription: "",
    script: "实验性角色",
  ...
  },
  {
    ...
    ability:
      "【实验性角色】夜晚可选择是否死亡，选择死亡后，一个爪牙成为利兹，活到最后即胜利。",
    fullDescription: "",
    script: "实验性角色",
...
roles.push(
  ...
  // 实验性外来者角色（默认不在前台展示/分配）
  {
    ...
    docRef: "blood_clocktower所有外来者.json#告密者",
  },
  {
    id: "puzzlemaster",
    name: "解谜大师",
    ...
    ruleNotes:
      "会有一名玩家因为解谜大师的能力在整局游戏中醉酒。解谜大师不会得知自己的猜测正确与否。",
  ...
  },
  {
    ...
    ruleNotes:
      "帽匠的能力使得所有邪恶角色的玩家可以选择变成与自己原本角色类型相同的角色。这些玩家可以选择不改变自己的角色。",
  ...
  },
  {
    ...
    ruleNotes:
      "食人魔选定了玩家之后,他的目标就不会发生变化。食人魔会在他的首个夜晚选择玩家后立即转变为那名玩家的阵营,但说书人不会告知食人魔转变后的阵营。",
  ...
  },
  {
    ...
    ruleNotes:
      "由说书人来选择获得哪一个爪牙的能力。瘟疫医生的能力效果会在剩余的游戏时间里持续生效。如果瘟疫医生在死亡时醉酒中毒,说书人不会获得爪牙能力。",
  ...
  },
  {
    ...
    ruleNotes:
      "如果一局游戏会使得善良阵营获胜,异端分子会导致所有善良玩家落败,且邪恶玩家获胜。反之亦然。异端分子的能力在他死亡时仍然正常生效,但在他醉酒中毒时不会生效。",
  ...
  },
  {
    ...
    ruleNotes:
      "隐士同时拥有角色列表中所有其他外来者的能力。他不会拥有不存在于角色列表中的外来者能力。由于隐士的设置调整,在初始设置需要移除一名外来者角色时,你可以移除隐士。",
  ...
  },
  {
    ...
    ruleNotes:
      "当游戏结束时,如果政客是善良阵营落败负最大责任的人,政客会加入邪恶阵营并一起获胜。政客也可以和其他角色一样,以善良阵营获胜。中毒或醉酒的政客不能转变阵营。",
...
export const groupedRoles = roles.reduce(
  (acc, role) => {
