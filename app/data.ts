...
export interface Script {
  ...
  difficulty: string;
  description: string;
  recommendedPlayers?: string; // 官方建议人数，如 "7-15人" 或 "5-8人"
  minPlayers?: number; // 剧本支持/建议最少人数
...
export const scripts: Script[] = [
  ...
  },
  {
    ...
    name: "无上愉悦",
    difficulty: "简单",
    recommendedPlayers: "5-8人",
    minPlayers: 5,
    maxPlayers: 8,
    description:
      "无上愉悦是汀西维尔模式的小型剧本，专为5-8人的小规模游戏设计。这个剧本的规则简单，角色能力直观，没有过于复杂的机制和误导性信息，非常适合新手玩家入门。善良阵营能够获得较为明确的信息，而邪恶阵营的能力也相对直接，游戏节奏快，通常在2-3小时内就能完成。非常适合朋友聚会、新人入门或者想要轻松体验游戏乐趣的场景。",
    roleIds: [
      "washerwoman",
      "investigator",
      "chef",
