...
const antagonismRoles = [
  'heretic', 'baron', 'leech', 'pit_hag', 'humeiniang',
  'actor', 'spy', 'godfather', 'evil_twin', 'widow', 'ghost', 'summoner',
  'frankenstein', 'drunk',
  'djinn', 'lamp_djinn', 'lamp_spirit', '灯神',
  'pit_hag_mr'
];
...
// 保存结果到文件
const result = { foundRoles, missingRoles, timestamp: new Date().toISOString() };
fs.writeFileSync(path.join(__dirname, '..', 'temp_antagonism_check.json'), JSON.stringify(result, null, 2));
