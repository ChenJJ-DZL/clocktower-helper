            ...
            return (
              <button
                ...
                className={`group relative overflow-hidden rounded-2xl px-5 sm:px-6 py-4 text-left shadow-xl transition-all duration-300 hover:-translate-y-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 cursor-pointer ${
                  isUnofficial
                    ? "border-2 border-yellow-300 bg-gradient-to-br from-amber-500 via-yellow-500 to-amber-600 hover:from-amber-400 hover:via-yellow-400 hover:to-amber-500 text-slate-950 shadow-lg shadow-amber-500/25 hover:shadow-amber-400/40 focus-visible:ring-yellow-400"
                    : "border border-white/10 bg-slate-900/70 backdrop-blur-md hover:border-purple-400/80 hover:bg-slate-800/90 hover:shadow-purple-500/30 focus-visible:ring-purple-400 text-white"
                }`}
              >
                <div
                  className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${
                    isUnofficial
                      ? "bg-gradient-to-br from-white/20 via-yellow-200/10 to-transparent"
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <div
                      className={`text-xl md:text-2xl font-black truncate ${
                        isUnofficial ? "text-slate-950 drop-shadow-sm" : "text-slate-50"
                      }`}
                    >
                      {script.name}
                    </div>
                    <span
                      className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-black shrink-0 ${
                        isUnofficial
                          ? "bg-slate-950/20 border border-slate-950/30 text-slate-950 shadow-sm"
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      {script.id.startsWith("custom_") && (
                        <button
                          className="text-red-900 hover:text-red-950 mr-1 z-10 relative text-xs cursor-pointer font-black"
                      ...
                      <span
                        className={`group-hover:translate-x-0.5 transition-transform text-sm font-black whitespace-nowrap ${
                          isUnofficial ? "text-slate-950 group-hover:text-black" : "text-purple-300"
                        }`}
                      >
                        进入配置 &raquo;
                      </span>
