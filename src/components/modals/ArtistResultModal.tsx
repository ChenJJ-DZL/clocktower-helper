    ...
    return (
        <ModalWrapper title="艺术家提问" onClose={() => onClose()}>
            <div className="p-4 text-white min-w-[300px]">
                <p className="mb-4 text-gray-300">艺术家发动了技能。说书人需要根据提问回答“是”、“否”或“不知道”。</p>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="text-sm font-semibold text-center">选择你的回答:</label>
                        <div className="flex justify-between gap-2">
                            {['是', '否', '不知道'].map(v => (
                                <button
                                    key={v}
                                    onClick={() => onClose(`结果: ${v}${question ? ` (提问: ${question})` : ''}`)}
