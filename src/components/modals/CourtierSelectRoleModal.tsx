  ...
  return (
    <ModalWrapper
      ...
      footer={
        <div className="flex gap-4 w-full justify-center">
          ...
          <button
            className="flex-1 max-w-xs py-3 sm:py-4 bg-purple-600 hover:bg-purple-500 rounded-xl font-black text-base sm:text-lg text-white transition shadow-lg shadow-purple-600/40 ring-2 ring-purple-400 active:scale-[0.98] disabled:opacity-50"
    ...
    >
      <div className="flex flex-col flex-1 p-2 sm:p-4 space-y-3 w-full">
        ...
        <div className="text-xs sm:text-sm text-purple-200/90">
