  ...
  return (
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 w-full">
          ...
          <div className="order-2 flex items-center gap-2">
            <button
              ...
              className="px-10 py-3 rounded-xl border border-white/20 bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold text-[26px] transition disabled:opacity-30 disabled:cursor-not-allowed flex items-center gap-2 cursor-pointer active:scale-95" title="上一位（iPhone 横屏可直接点）"
            >
              <span>⬅</span>
          ...
          <div className="order-3 flex items-center gap-2">
            <button
              type="button"
              onClick={handleNext}
              className={`px-12 py-4 rounded-xl text-white font-black text-[28px] transition shadow-lg flex items-center gap-2 cursor-pointer active:scale-95 ${
    ...
    >
      <div className="flex flex-col h-full space-y-3 overflow-hidden">
        {/* 顶部进度与提示条 */}
        <div className="flex items-center justify-between px-4 py-2 rounded-xl bg-slate-900/90 border border-white/10 text-[18px] text-slate-300 shrink-0 gap-3">
              ...
              <div className="w-[40%] shrink-0 flex flex-col justify-between p-5 sm:p-6 rounded-2xl bg-gradient-to-b from-slate-900/95 via-slate-900/90 to-slate-950 border-2 border-white/10 shadow-2xl space-y-4 overflow-y-auto">
                ...
                <div className="flex items-center gap-4 py-1 shrink-0">
                  ...
                  <div className="space-y-1 min-w-0 flex-1">
                    <h2
                      className={`text-4xl sm:text-5xl font-black tracking-tight ${teamTheme.highlightText} drop-shadow-md leading-tight`}
                    >
                      {displayRole.name}
                    </h2>
                    <p className="text-[19px] text-slate-300 font-mono font-medium">
                ...
                <div className="p-4 rounded-xl bg-black/40 border border-white/15 space-y-2 flex-1 flex flex-col justify-center">
                  <div className="flex items-center gap-2 text-[16px] font-bold text-amber-300 uppercase tracking-wider">
                    <span>⚡</span>
                    <span>【角色能力】</span>
                  </div>
                  <p className="text-[26px] font-medium text-slate-100 leading-relaxed pl-1">
              ...
              <div className="flex-1 flex flex-col p-5 sm:p-6 rounded-2xl bg-slate-900/90 border border-white/10 shadow-2xl space-y-3.5 overflow-hidden">
                ...
                <div className="flex items-center justify-between border-b border-white/10 pb-2.5 shrink-0">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-[20px] font-bold text-slate-200">
                      官方玩法推荐 & 进阶技巧
                    </h3>
                  </div>
                  {wikiDetails?.url && (
                    <a
                      ...
                      className="text-[18px] text-sky-400 hover:text-sky-300 underline flex items-center gap-1 px-2 py-1 rounded bg-sky-950/40 border border-sky-500/30"
                    >
                      <span>百科原页</span>
                      <span>↗</span>
                    </a>
                ...
                <div className="flex-1 overflow-y-auto space-y-3 pr-2">
                  ...
                  {wikiDetails?.flavorQuote && (
                    <div className="p-3 rounded-xl bg-white/5 border-l-4 border-amber-500 text-[18px] text-slate-300 italic">
                      {wikiDetails.flavorQuote}
                    </div>
                  )}
                  ...
                  <div className="space-y-2.5">
                    <div className="flex items-center gap-1.5 text-[16px] font-bold text-amber-300">
                      <span>💡</span>
                      <span>核心打法与发言建议</span>
                    </div>
                    ...
                    wikiDetails.strategyTips.length > 0 ? (
                      <div className="space-y-2 pl-0.5">
                        {wikiDetails.strategyTips.slice(0, 6).map((tip, i) => (
                          <div
                            key={tip}
                            className="flex items-start gap-2.5 text-[18px] text-slate-200 leading-relaxed bg-black/25 p-3 rounded-xl border border-white/5 shadow-sm"
                          >
                      ...
                      <p className="text-[20px] text-slate-400 pl-4">
                  ...
                  {wikiDetails?.overview && (
                    <div className="space-y-1.5 pt-2 border-t border-white/10">
                      ...
                      <p className="text-[18px] text-slate-300 leading-relaxed pl-2">
                        {wikiDetails.overview}
                      </p>
                    </div>
                  )}
