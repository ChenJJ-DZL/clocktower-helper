...
describe("《黯月初升》(Bad Moon Rising) 全 25 角色百科范例与 UI 同步测试", () => {
  ...
  describe("镇民角色 (Townsfolk) 范例与 UI 验证", () => {
    it("祖母 (Grandmother)：首夜得知孙子角色与座位，孙子被恶魔杀害时祖母随之死亡", async () => {
      ...
      const seats: any[] = [
        { id: 0, playerName: "P1", role: { id: "grandmother", name: "祖母", type: "townsfolk" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
        { id: 1, playerName: "P2", role: { id: "sailor", name: "水手", type: "townsfolk" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
        { id: 2, playerName: "P3", role: { id: "pukka", name: "普卡", type: "demon" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
      ];
      const ctx: MiddlewareContext = {
        snapshot: { nightCount: 1, gamePhase: "firstNight", seats, statusEffects: {}, isVortoxWorld: false, statusEffectMap: {} } as any,
        actionNode: { seatId: 0, roleId: "grandmother", roleName: "祖母", priority: 30, isFirstNightOnly: true, abilityId: "grandmother_first_night_ability", targetIds: [], processed: false, success: false, meta: {} } as any,
        targetIds: [],
        meta: {},
        aborted: false,
      };
