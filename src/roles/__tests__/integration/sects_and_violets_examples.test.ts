...
describe("《梦殒春宵》(Sects & Violets) 全 25 角色百科范例与 UI 同步测试", () => {
  ...
  describe("镇民角色 (Townsfolk) 范例与 UI 验证", () => {
    it("钟表匠 (Clockmaker)：首夜得知恶魔与最近爪牙之间的座位距离", async () => {
      ...
      const seats: any[] = [
        { id: 0, playerName: "P1", role: { id: "clockmaker", name: "钟表匠", type: "townsfolk" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
      ...
      const ctx: MiddlewareContext = {
        ...
        actionNode: { seatId: 0, roleId: "clockmaker", roleName: "钟表匠", priority: 30, isFirstNightOnly: true, abilityId: "clockmaker_first_night_ability", targetIds: [], processed: false, success: false, meta: {} } as any,
        targetIds: [],
        meta: {},
        aborted: false,
      };
