...
describe("《梦殒春宵》爪牙角色官方范例逐条验证 (S&V Minions Examples)", () => {
  ...
  describe("女巫 (Witch)", () => {
    it("范例 1: 夜晚女巫诅咒了贤者。下个白天，贤者提名了筑梦师。说书人立即宣布贤者死亡。玩家仍然投票给筑梦师。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "witch", name: "女巫", type: "minion" } as any, isDead: false },
        ...
        { id: 3, role: { id: "artist", name: "艺术家", type: "townsfolk" } as any, isDead: false },
      ] as any;
    ...
    it("范例 2: 女巫诅咒了自己。下个白天，女巫提名恶魔并死亡。玩家对是否要处决恶魔进行投票。", async () => {
      const seats: Seat[] = [
        ...
        { id: 3, role: { id: "clockmaker", name: "钟表匠", type: "townsfolk" } as any, isDead: false },
      ] as any;
    ...
    it("范例 3: 女巫诅咒了呆瓜。方古攻击了呆瓜，呆瓜变成了方古。新的方古被诅咒并提名，新的方古死亡，善良胜利。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "witch", name: "女巫", type: "minion" } as any, isDead: false },
        { id: 1, role: { id: "klutz", name: "呆瓜", type: "outsider" } as any, isDead: false },
        { id: 2, role: { id: "artist", name: "艺术家", type: "townsfolk" } as any, isDead: false },
        { id: 3, role: { id: "clockmaker", name: "钟表匠", type: "townsfolk" } as any, isDead: false },
      ] as any;
    ...
    it("范例 4: 女巫诅咒了博学者。在恶魔杀死一名玩家后，只剩三名玩家存活，诅咒被移除。博学者可以安全提名。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "witch", name: "女巫", type: "minion" } as any, isDead: false },
        { id: 1, role: { id: "savant", name: "博学者", type: "townsfolk" } as any, isDead: false },
        { id: 2, role: { id: "fang_gu", name: "方古", type: "demon" } as any, isDead: false },
      ] as any;
  ...
  describe("麻脸巫婆 (Pit-Hag)", () => {
    it("范例 1: 麻脸巫婆试图将博学者变成贤者，但无事发生，因为贤者在场。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "pit_hag", name: "麻脸巫婆", type: "minion" } as any, isDead: false },
        { id: 1, role: { id: "savant", name: "博学者", type: "townsfolk" } as any, isDead: false },
        { id: 2, role: { id: "sage", name: "贤者", type: "townsfolk" } as any, isDead: false },
      ] as any;
    ...
    it("范例 2: 麻脸巫婆将卖花女孩变成镜像双子。现在，有一名善良阵营的镜像双子。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "pit_hag", name: "麻脸巫婆", type: "minion" } as any, isDead: false },
        { id: 1, role: { id: "flowergirl", name: "卖花女孩", type: "townsfolk" } as any, isDead: false },
      ] as any;
