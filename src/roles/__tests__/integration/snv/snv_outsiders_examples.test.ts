...
describe("《梦殒春宵》外来者角色官方范例逐条验证 (S&V Outsiders Examples)", () => {
  ...
  describe("心上人 (Sweetheart)", () => {
    it("范例 1: 心上人死了。数学家现在醉酒了，并可能在夜晚获得错误信息。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "sweetheart", name: "心上人", type: "outsider" } as any, isDead: true },
        { id: 1, role: { id: "mathematician", name: "数学家", type: "townsfolk" } as any, isDead: false },
      ] as any;
  ...
  describe("理发师 (Barber)", () => {
    it("范例 1: 理发师死了。恶魔本来想要交换钟表匠和杂耍艺人，但随后决定什么都不做。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "barber", name: "理发师", type: "outsider" } as any, isDead: true },
        { id: 1, role: { id: "clockmaker", name: "钟表匠", type: "townsfolk" } as any, isDead: false },
        { id: 2, role: { id: "juggler", name: "杂耍艺人", type: "townsfolk" } as any, isDead: false },
      ] as any;
    ...
    it("范例 2: 理发师死了。恶魔交换了存活的神谕者和死亡的理发师。现在，有一名存活的理发师和一名死亡的神谕者。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "barber", name: "理发师", type: "outsider" } as any, isDead: true },
        { id: 1, role: { id: "oracle", name: "神谕者", type: "townsfolk" } as any, isDead: false },
      ] as any;
      ...
      expect(seat1.isDead).toBe(false);
    });
    ...
    it("范例 4: 理发师死了。亡骨魔与死去的心上人交换角色。曾经的亡骨魔现在是邪恶的心上人。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "barber", name: "理发师", type: "outsider" } as any, isDead: true },
        { id: 1, role: { id: "vigormortis", name: "亡骨魔", type: "demon" } as any, isDead: false, alignment: "evil" },
        { id: 2, role: { id: "sweetheart", name: "心上人", type: "outsider" } as any, isDead: true, alignment: "good" },
      ] as any;
  ...
  describe("呆瓜 (Klutz)", () => {
    it("范例 1: 呆瓜死于处决。经过一番争吵，呆瓜选择了一名玩家，而该玩家是善良的女裁缝。夜幕降临，游戏继续。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "klutz", name: "呆瓜", type: "outsider" } as any, isDead: true },
        { id: 1, role: { id: "seamstress", name: "女裁缝", type: "townsfolk" } as any, isDead: false, alignment: "good" },
      ] as any;
