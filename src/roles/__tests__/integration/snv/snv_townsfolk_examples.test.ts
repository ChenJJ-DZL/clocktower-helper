...
describe("《梦殒春宵》镇民角色官方范例逐条验证 (S&V Townsfolk Examples)", () => {
  ...
  describe("钟表匠 (Clockmaker)", () => {
    it("范例 1: 方古坐在麻脸巫婆旁边。钟表匠得知了“1”。", async () => {
      const seats: Seat[] = [
        ...
        { id: 2, role: { id: "clockmaker", name: "钟表匠", type: "townsfolk" } as any, isDead: false },
        { id: 3, role: { id: "sage", name: "贤者", type: "townsfolk" } as any, isDead: false },
        { id: 4, role: { id: "artist", name: "艺术家", type: "townsfolk" } as any, isDead: false },
      ] as any;
    ...
    it("范例 2: 诺-达鲺顺时针方向依次坐着筑梦师、舞蛇人，然后是镜像双子。诺-达鲺逆时针方依次坐着畸形秀演员、心上人、哲学家、贤者，然后是女巫。因为女巫与恶魔的距离为五，而镜像双子与恶魔的距离为三，所以钟表匠得知了“3”。", async () => {
      const seats: Seat[] = [
        ...
        { id: 1, role: { id: "dreamer", name: "筑梦师", type: "townsfolk" } as any, isDead: false },
        { id: 2, role: { id: "snake_charmer", name: "舞蛇人", type: "townsfolk" } as any, isDead: false },
        { id: 3, role: { id: "evil_twin", name: "镜像双子", type: "minion" } as any, isDead: false },
        { id: 4, role: { id: "clockmaker", name: "钟表匠", type: "townsfolk" } as any, isDead: false },
        { id: 5, role: { id: "witch", name: "女巫", type: "minion" } as any, isDead: false },
        { id: 6, role: { id: "sage", name: "贤者", type: "townsfolk" } as any, isDead: false },
        { id: 7, role: { id: "philosopher", name: "哲学家", type: "townsfolk" } as any, isDead: false },
        { id: 8, role: { id: "sweetheart", name: "心上人", type: "outsider" } as any, isDead: false },
        { id: 9, role: { id: "mutant", name: "畸形秀演员", type: "outsider" } as any, isDead: false },
      ] as any;
    ...
    it("范例 3: 方古与两名旅行者相邻，一善一恶。洗脑师与其中一名旅行者相邻。在第一个晚上，钟表匠得知了“2”，因为邪恶的旅行者不是爪牙。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "fang_gu", name: "方古", type: "demon" } as any, isDead: false },
        { id: 1, role: { id: "gunslinger", name: "枪手", type: "traveler" } as any, isDead: false, alignment: "evil" },
        { id: 2, role: { id: "cerenovus", name: "洗脑师", type: "minion" } as any, isDead: false },
        { id: 3, role: { id: "beggar", name: "乞丐", type: "traveler" } as any, isDead: false, alignment: "good" },
        { id: 4, role: { id: "clockmaker", name: "钟表匠", type: "townsfolk" } as any, isDead: false },
      ] as any;
  ...
  describe("筑梦师 (Dreamer)", () => {
    it("范例 1: 筑梦师选择一名玩家，该玩家是畸形秀演员。筑梦师得知该玩家是畸形秀演员或洗脑师。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "dreamer", name: "筑梦师", type: "townsfolk" } as any, isDead: false },
        { id: 1, role: { id: "mutant", name: "畸形秀演员", type: "outsider" } as any, isDead: false },
      ] as any;
    ...
    it("范例 3: 在白天，镜像双子和艺术家都声称自己是艺术家。那天晚上，筑梦师选择了镜像双子。说书人展示镜像双子和心上人，或镜像双子和艺术家。", async () => {
      const seats: Seat[] = [
        ...
        { id: 2, role: { id: "artist", name: "艺术家", type: "townsfolk" } as any, isDead: false },
      ] as any;
    ...
    it("范例 4: 筑梦师选择了一名玩家，他的真实角色是涡流。因为涡流，信息必须错误：得知神谕者或诺-达鲺。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "dreamer", name: "筑梦师", type: "townsfolk" } as any, isDead: false },
        { id: 1, role: { id: "vortox", name: "涡流", type: "demon" } as any, isDead: false },
      ] as any;
  ...
  describe("舞蛇人 (Snake Charmer)", () => {
    it("范例 1: 舞蛇人选择的玩家是麻脸巫婆，无事发生。下个夜晚，舞蛇人选择他自己，依旧无事发生。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "snake_charmer", name: "舞蛇人", type: "townsfolk" } as any, isDead: false },
        { id: 1, role: { id: "pit_hag", name: "麻脸巫婆", type: "minion" } as any, isDead: false },
      ] as any;
    ...
    it("范例 2: 舞蛇人选择的玩家是亡骨魔。舞蛇人立即变成邪恶的亡骨魔，曾经是亡骨魔的玩家变成善良的舞蛇人并中毒。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "snake_charmer", name: "舞蛇人", type: "townsfolk" } as any, isDead: false },
        { id: 1, role: { id: "vigormortis", name: "亡骨魔", type: "demon" } as any, isDead: false },
      ] as any;
    ...
    it("范例 3: 麻脸巫婆把自己变成了舞蛇人。然后舞蛇人选择了方古玩家。舞蛇人变成了方古，方古变成了中毒的舞蛇人。但两者仍然邪恶。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "snake_charmer", name: "舞蛇人", type: "townsfolk" } as any, isDead: false, alignment: "evil", isEvilConverted: true },
        { id: 1, role: { id: "fang_gu", name: "方古", type: "demon" } as any, isDead: false, alignment: "evil" },
      ] as any;
  ...
  describe("数学家 (Mathematician)", () => {
    it("范例 1: 中毒的神谕者得知有两名死亡玩家是邪恶的，但是事实上有三名死亡玩家是邪恶的。所有其他能力正常生效。数学家得知了“1”。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "mathematician", name: "数学家", type: "townsfolk" } as any, isDead: false },
        { id: 1, role: { id: "oracle", name: "神谕者", type: "townsfolk" } as any, isDead: false, isPoisoned: true },
      ] as any;
  ...
  describe("卖花女孩 (Flowergirl)", () => {
    it("范例 1: 今天白天有一项提名。很多玩家投票，被提名的玩家被处决。但恶魔没有参与投票。那天晚上，卖花女孩得知了“否”。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "flowergirl", name: "卖花女孩", type: "townsfolk" } as any, isDead: false },
        { id: 1, role: { id: "fang_gu", name: "方古", type: "demon" } as any, isDead: false },
      ] as any;
  ...
  describe("女裁缝 (Seamstress)", () => {
    it("范例 1: 在第一个夜晚，女裁缝选择了两名玩家，他们是理发师和钟表匠。因为他俩都是善良的，女裁缝得知“是”。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "seamstress", name: "女裁缝", type: "townsfolk" } as any, isDead: false },
        { id: 1, role: { id: "barber", name: "理发师", type: "outsider" } as any, isDead: false },
        { id: 2, role: { id: "clockmaker", name: "钟表匠", type: "townsfolk" } as any, isDead: false },
      ] as any;
    ...
    it("范例 3: 麻脸巫婆把数学家变成了女巫，女巫仍然是善良的。当晚，女裁缝选择了两名玩家，他们是女巫和城镇公告员。女裁缝得知“是”，因为他们是善良的。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "seamstress", name: "女裁缝", type: "townsfolk" } as any, isDead: false },
        { id: 1, role: { id: "witch", name: "女巫", type: "minion" } as any, isDead: false, alignment: "good", isGoodConverted: true },
        { id: 2, role: { id: "town_crier", name: "城镇公告员", type: "townsfolk" } as any, isDead: false, alignment: "good" },
      ] as any;
  ...
  describe("哲学家 (Philosopher)", () => {
    it("范例 1: 哲学家选择获得筑梦师能力。从现在起，他将在筑梦师应该行动时进行行动。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "philosopher", name: "哲学家", type: "townsfolk" } as any, isDead: false },
        { id: 1, role: { id: "sage", name: "贤者", type: "townsfolk" } as any, isDead: false },
      ] as any;
    ...
    it("范例 2: 在第三个夜晚，哲学家选择获得钟表匠的能力。当晚，他得知了恶魔与爪牙之间的最近的距离。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "philosopher", name: "哲学家", type: "townsfolk" } as any, isDead: false },
        { id: 1, role: { id: "fang_gu", name: "方古", type: "demon" } as any, isDead: false },
        { id: 2, role: { id: "witch", name: "女巫", type: "minion" } as any, isDead: false },
      ] as any;
  ...
  describe("艺术家 (Artist)", () => {
    it("范例 1: 艺术家问：“恶魔坐在棕色椅子上吗？”说书人回答：“不是”，因为此时恶魔坐在黑色椅子上。", async () => {
      const ctx: any = {
        snapshot: { nightCount: 1, seats: [{ id: 0, role: { id: "artist" }, isDead: false, }] } as any,
  ...
  describe("贤者 (Sage)", () => {
    it("范例 1: 第二个夜晚，恶魔杀死了贤者。说书人为贤者指出了两名玩家，其中一名是恶魔。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "sage", name: "贤者", type: "townsfolk" } as any, isDead: true },
        { id: 1, role: { id: "fang_gu", name: "方古", type: "demon" } as any, isDead: false },
        { id: 2, role: { id: "clockmaker", name: "钟表匠", type: "townsfolk" } as any, isDead: false },
      ] as any;
    ...
    it("范例 2: 在最后一夜，恶魔杀死了醉酒的贤者。说书人为贤者指出了一名死亡玩家和剩下的一名存活善良玩家，没有给他正确信息。", async () => {
      const seats: Seat[] = [
        { id: 0, role: { id: "sage", name: "贤者", type: "townsfolk" } as any, isDead: true, isDrunk: true },
        { id: 1, role: { id: "fang_gu", name: "方古", type: "demon" } as any, isDead: false },
        { id: 2, role: { id: "clockmaker", name: "钟表匠", type: "townsfolk" } as any, isDead: false },
        { id: 3, role: { id: "artist", name: "艺术家", type: "townsfolk" } as any, isDead: true },
      ] as any;
