...
describe("《暗流涌动》(Trouble Brewing) 全 22 角色百科范例与 UI 同步测试", () => {
  ...
  describe("镇民角色 (Townsfolk) 范例与 UI 验证", () => {
    it("洗衣妇 (Washerwoman)：首夜得知 2 名玩家中 1 名是特定镇民", async () => {
      ...
      const ctx: MiddlewareContext = {
        ...
        actionNode: { seatId: 0, roleId: "washerwoman", roleName: "洗衣妇", priority: 30, isFirstNightOnly: true, abilityId: "washerwoman_first_night_ability", targetIds: [], processed: false, success: false, meta: {} } as any,
        targetIds: [],
        meta: {},
        aborted: false,
      };
    ...
    it("图书管理员 (Librarian)：首夜得知 2 名玩家中 1 名是特定外来者（若无则得知 0）", async () => {
      ...
      const seats: any[] = [
        { id: 0, playerName: "P1", role: { id: "librarian", name: "图书管理员", type: "townsfolk" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
        { id: 1, playerName: "P2", role: { id: "saint", name: "圣徒", type: "outsider" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
        { id: 2, playerName: "P3", role: { id: "imp", name: "小恶魔", type: "demon" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
      ];
      const ctx: MiddlewareContext = {
        snapshot: { nightCount: 1, gamePhase: "firstNight", seats, statusEffects: {}, isVortoxWorld: false, statusEffectMap: {} } as any,
        actionNode: { seatId: 0, roleId: "librarian", roleName: "图书管理员", priority: 31, isFirstNightOnly: true, abilityId: "librarian_first_night_ability", targetIds: [], processed: false, success: false, meta: {} } as any,
        targetIds: [],
        meta: {},
        aborted: false,
      };
    ...
    it("调查员 (Investigator)：首夜得知 2 名玩家中 1 名是特定爪牙", async () => {
      ...
      const seats: any[] = [
        { id: 0, playerName: "P1", role: { id: "investigator", name: "调查员", type: "townsfolk" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
      ...
      const ctx: MiddlewareContext = {
        snapshot: { nightCount: 1, gamePhase: "firstNight", seats, statusEffects: {}, isVortoxWorld: false, statusEffectMap: {} } as any,
        actionNode: { seatId: 0, roleId: "investigator", roleName: "调查员", priority: 32, isFirstNightOnly: true, abilityId: "investigator_first_night_ability", targetIds: [], processed: false, success: false, meta: {} } as any,
        targetIds: [],
        meta: {},
        aborted: false,
      };
    ...
    it("厨师 (Chef)：首夜得知邻座邪恶玩家对数", async () => {
      ...
      const seats: any[] = [
        { id: 0, playerName: "P1", role: { id: "chef", name: "厨师", type: "townsfolk" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
        { id: 1, playerName: "P2", role: { id: "poisoner", name: "投毒者", type: "minion" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
        { id: 2, playerName: "P3", role: { id: "imp", name: "小恶魔", type: "demon" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
      ];
      const ctx: MiddlewareContext = {
        snapshot: { nightCount: 1, gamePhase: "firstNight", seats, statusEffects: {}, isVortoxWorld: false, statusEffectMap: {} } as any,
        actionNode: { seatId: 0, roleId: "chef", roleName: "厨师", priority: 33, isFirstNightOnly: true, abilityId: "chef_first_night_ability", targetIds: [], processed: false, success: false, meta: {} } as any,
        targetIds: [],
        meta: {},
        aborted: false,
      };
    ...
    it("共情者 (Empath)：每夜得知与其相邻的存活玩家中有几名是邪恶的", async () => {
      ...
      const seats: any[] = [
        { id: 0, playerName: "P1", role: { id: "empath", name: "共情者", type: "townsfolk" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
        { id: 1, playerName: "P2", role: { id: "poisoner", name: "投毒者", type: "minion" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
      ...
      const ctx: MiddlewareContext = {
        ...
        actionNode: { seatId: 0, roleId: "empath", roleName: "共情者", priority: 34, isFirstNightOnly: false, abilityId: "empath_night_ability", targetIds: [], processed: false, success: false, meta: {} } as any,
        targetIds: [],
        meta: {},
        aborted: false,
      };
    ...
    it("送葬者 (Undertaker)：仅在当天有玩家死于处决时唤醒并得知其真实角色", async () => {
      ...
      const seats: any[] = [
        { id: 0, playerName: "P1", role: { id: "undertaker", name: "送葬者", type: "townsfolk" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
        { id: 1, playerName: "P2", role: { id: "saint", name: "圣徒", type: "outsider" }, isDead: true, isAlive: false, executedToday: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
      ];
      const ctx: MiddlewareContext = {
        snapshot: { nightCount: 2, gamePhase: "night", seats, executedToday: 1, statusEffects: {}, isVortoxWorld: false, statusEffectMap: {} } as any,
        actionNode: { seatId: 0, roleId: "undertaker", roleName: "送葬者", priority: 36, isFirstNightOnly: false, abilityId: "undertaker_night_ability", targetIds: [], processed: false, success: false, meta: {} } as any,
        targetIds: [],
        meta: {},
        aborted: false,
      };
  ...
  describe("外来者与爪牙及恶魔 (Outsiders, Minions & Demons) 范例验证", () => {
    ...
    it("投毒者 (Poisoner)：每夜使 1 名玩家中毒", async () => {
      ...
      const seats: any[] = [
        { id: 0, playerName: "P1", role: { id: "poisoner", name: "投毒者", type: "minion" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
        { id: 1, playerName: "P2", role: { id: "monk", name: "僧侣", type: "townsfolk" }, isDead: false, isAlive: true, isDrunk: false, isPoisoned: false, statusEffects: [] },
      ];
      const ctx: MiddlewareContext = {
        snapshot: { nightCount: 2, gamePhase: "night", seats, statusEffects: {}, isVortoxWorld: false, statusEffectMap: {} } as any,
        actionNode: { seatId: 0, roleId: "poisoner", roleName: "投毒者", priority: 10, isFirstNightOnly: false, abilityId: "poisoner_night_ability", targetIds: [1], processed: false, success: false, meta: {} } as any,
        targetIds: [1],
        meta: {},
        aborted: false,
      };
