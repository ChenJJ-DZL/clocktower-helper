...
const ROLES: RoleTest[] = [
  ...
  { roleName: "猎手", script: "暗流涌动", demon: "小恶魔", townsfolk: ["洗衣妇","厨师"], minion: "投毒者" },
  // ── 黯月初升 (Bad Moon Rising) ──
  { roleName: "赌徒", script: "黯月初升", demon: "僵怖", townsfolk: ["祖母","水手"], minion: "刺客" },
  { roleName: "造谣者", script: "黯月初升", demon: "僵怖", townsfolk: ["祖母","水手"], minion: "刺客" },
  { roleName: "修补匠", script: "黯月初升", demon: "僵怖", townsfolk: ["祖母","水手"], minion: "刺客" },
  { roleName: "吟游诗人", script: "黯月初升", demon: "僵怖", townsfolk: ["祖母","水手"], minion: "刺客" },
  // ── 梦殒春宵 (Sects & Violets) ──
  { roleName: "艺术家", script: "梦殒春宵", demon: "涡流", townsfolk: ["筑梦师","数学家"], minion: "麻脸巫婆" },
  { roleName: "博学者", script: "梦殒春宵", demon: "涡流", townsfolk: ["筑梦师","数学家"], minion: "麻脸巫婆" },
  { roleName: "杂耍艺人", script: "梦殒春宵", demon: "涡流", townsfolk: ["筑梦师","数学家"], minion: "麻脸巫婆" },
  { roleName: "哲学家", script: "梦殒春宵", demon: "涡流", townsfolk: ["筑梦师","数学家"], minion: "麻脸巫婆" },
];
...
test.describe("全剧本 DAY 能力角色 (Phase 1+2)", () => {
  for (const role of ROLES) {
    test(`${role.roleName} (${role.script})`, async ({ page }) => {
      ...
      for (let m = 0; m < 10; m++) {
        const modal = page.locator(".fixed.inset-0.z-50, .fixed.inset-0.z-\\[3200\\], [data-modal-key]").first();
