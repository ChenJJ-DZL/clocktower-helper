/**
 * 全角色E2E验证 - TB(21)+BMR(25)+S&V(25)=71角色
 *
 * 对每个角色验证：
 *   1. 剧本选择 + 角色分配成功
 *   2. 游戏开始 + 夜间推进不崩溃
...
interface RoleEntry { name: string; id: string; script: string; demon: string; fill3: string[]; }

// fill3 = [seat1, seat2, seat3] — 全部来自对应剧本
const TB: RoleEntry[] = [
...
const BMR: RoleEntry[] = [
  ...
  ["茶艺师","茶艺师","祖母","刺客","水手"],["和平守护","和平守护","祖母","刺客","水手"],
...
const SV: RoleEntry[] = [
  ...
  ["贤者","贤者","筑梦师","数学家","麻脸巫婆"],
  ["畸形秀演员","畸形秀演员","筑梦师","数学家","麻脸巫婆"],
  ["心上人","心上人","筑梦师","数学家","麻脸巫婆"],
  ["理发师","理发师","筑梦师","数学家","麻脸巫婆"],["呆瓜","呆瓜","筑梦师","数学家","麻脸巫婆"],
  ["镜像双子","镜像双子","筑梦师","数学家","女巫"],["女巫","女巫","筑梦师","数学家","镜像双子"],
  ["洗脑师","洗脑师","筑梦师","数学家","镜像双子"],["麻脸巫婆","麻脸巫婆","筑梦师","数学家","镜像双子"],
  ["方古","方古","筑梦师","数学家","麻脸巫婆"],["亡骨魔","亡骨魔","筑梦师","数学家","麻脸巫婆"],
  ["诺-达鲺","诺-达鲺","筑梦师","数学家","麻脸巫婆"],
].map(r => ({name: r[0], id: r[0], script: "梦殒春宵", demon: "涡流", fill3: r.slice(2)}));

// Run it
const ALL = [...TB, ...BMR, ...SV];

test.describe("全角色花名册", () => {
