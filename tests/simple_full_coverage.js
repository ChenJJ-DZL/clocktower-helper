      ...
      alivePlayers.forEach((seat) => {
        ...
        const hasDayAbility =
          ...
          (seat.role.ability.includes("白天") ||
            ...
            seat.role.name.includes("猎手") || // 猎手有白天能力
            seat.role.name.includes("市长") || // 市长有白天能力
            seat.role.name.includes("贞洁者")); // 贞洁者有提名能力
...
async function runFullCoverageTest() {
  console.log("🚀 血染钟楼全量测试系统启动 (JavaScript版)");
